...
command-execution claim. ADR-0135 exposes the base transition claim examples
...
self-mailbox init command execution to predicate-result. ADR-0134 exposes the
