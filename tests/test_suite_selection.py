...
EXPECTED_EXTENDED_MODULES = {
    ...
    "tests.test_fixed_point_bridge_predecessor_proof_readiness_coverage",
    ...
    "tests.test_fixed_point_diagonal_instance_closure_proof_target",
    "tests.test_fixed_point_diagonal_instance_closure_proof_readiness",
    ...
    "tests.test_fixed_point_selected_root_proof_target_coverage",
    "tests.test_fixed_point_selected_root_proof_readiness_coverage",
    ...
    "tests.test_fixed_point_substitution_representability_proof_target",
    ...
    "tests.test_fixed_point_substitution_graph_correctness_proof_target",
    "tests.test_fixed_point_substitution_graph_correctness_proof_readiness",
